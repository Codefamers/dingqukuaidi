...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.NormalTextViewHolder> {
    private Context context;
    private NormalTextViewHolder normalTextViewHolder;
    private JSONArray arrayData;
    public SearchAdapter( JSONArray arrayData) {
    ...
    public NormalTextViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return normalTextViewHolder = new NormalTextViewHolder(LayoutInflater.from(
                context).inflate(R.layout.view_search_recycle_item, parent,
                false));
    }
    //绑定数据
    @Override
